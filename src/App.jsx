...
const ClientCreation = lazy(() => import("./Components/MainCards/Clients/ClientCreation"));
const ClientUpdate = lazy(() => import("./Components/MainCards/Clients/ClientUpdate"));
const ClientDetails = lazy(() => import("./Components/MainCards/Clients/ClientDetails"));
const BranchDetails = lazy(() => import("./Components/MainCards/BranchD/BranchDetails"));
const PurchaseInvoice = lazy(() => import("./pages/PurchaseInvoice"));
const SalesInvoice = lazy(() => import("./pages/SalesInvoice"));
const CreditNote = lazy(() => import("./Components/MainCards/Clients/Credit Note/CreditNote"));
const DebitNote = lazy(() => import("./Components/MainCards/Clients/DebitNote/DebitNote"));
const IncomeDebitNote = lazy(() => import("./Components/MainCards/Clients/IncomeDebitNote/IncomeDebitNote"));
const ExpenseCreditNote = lazy(() => import("./Components/MainCards/Clients/ExpenseCreditNote/ExpenseCreditNote"));
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<ProtectedLayout />}>
              ...
              <Route path="/clientDetails/acknowledgement/:id" element={<AckDetails />} />
            </Route>
          </Route>
