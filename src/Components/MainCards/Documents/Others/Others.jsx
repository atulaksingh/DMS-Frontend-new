...
import OthersCreation from "./OthersCreation";
...

        {
            ...
            options: {
                customBodyRenderLite: (dataIndex) => {
                    const rowData = othersData[dataIndex];
                    return (
                        <div>
                            {/* <AirCard rowId={rowData.id} /> */}
                            <OthersCard rowId={rowData.id} />
                        </div>
                    );
                },
                setCellHeaderProps: () => ({
