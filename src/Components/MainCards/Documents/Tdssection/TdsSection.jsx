...
// import TdsSectionCard from "./TaxAuditCard";
import TdsSectionCreation from "./TdsSectionCreation";
import TdsSectionCard from "./TdsSectionCard";
...

    {
      ...
      options: {
        customBodyRenderLite: (dataIndex) => {
          const rowData = tdsSectionData[dataIndex];
          return (
            <div>
              <TdsSectionCard rowId={rowData.id} />
              {/* <TdsPaymentCreation rowId={rowData.id} /> */}
            </div>
          );
        },
        setCellHeaderProps: () => ({
